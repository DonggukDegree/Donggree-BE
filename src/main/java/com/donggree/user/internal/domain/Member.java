...
public class Member extends BaseEntity {
    ...
    private Member(
        ...
        this.name = requireText(name, "name", 5);
        this.profileUrl = requireText(profileUrl, "profileUrl", 512);
        this.role = Role.STUDENT;
    }

    public static Member registerKakaoMember(
            String oauthId,
            String email,
            String name,
            String profileUrl
    ) {
        return new Member(oauthId, email, name, profileUrl);
    }
