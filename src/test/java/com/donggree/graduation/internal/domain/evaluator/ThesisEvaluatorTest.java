...
class ThesisEvaluatorTest extends EvaluatorTestSupport {
    ...
    void 종합설계1과_2를_이수하면_충족이다() {
        ...
        EvaluationContext ctx = contextNoClassification(transcriptWith(6, 4.0, false, null, false, "단일", "S1", records));
    ...
    void 종합설계1만_이수하면_미충족이다() {
        ...
        EvaluationContext ctx = contextNoClassification(transcriptWith(3, 4.0, false, null, false, "단일", "S1", records));
    ...
    void 학석사연계과정_학생은_면제_처리된다() {
        EvaluationContext ctx = contextNoClassification(
                transcriptWith(0, 4.0, false, null, false, "학석사연계과정", "S1", List.of()));
    ...
    void 아무_과목도_이수하지_않으면_미충족이다() {
        EvaluationContext ctx = contextNoClassification(
                transcriptWith(0, 4.0, false, null, false, "단일", "S1", List.of()));
